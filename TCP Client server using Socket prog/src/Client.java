...
public class Client extends JFrame implements ActionListener {
    ...
    Client() {
        ...
        /* Profile pic
        Profile_pic = new ImageIcon(ClassLoader.getSystemResource("Icons/profile.png"));
        Image ProfilePic = Profile_pic.getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT);
        Profile_pic_lb = new JLabel(new ImageIcon(ProfilePic));
        Profile_pic_lb.setBounds(50, 10, 50, 50);
        Top_Panel.add(Profile_pic_lb);
*/
        // Name label
        Name_lb = new JLabel("Sham");
    ...
    public static void main(String[] args) {
        ...
        Client c = new Client();
        try {
            Socket s = new Socket("127.0.0.1", 1104);
            ...
            while (true) {
                ...
                Client.Mess_Box_Panel.add(Client.Vertical, BorderLayout.PAGE_START);


                Client.Mess_Box_Panel.validate();
            }
    } catch (Exception e) {
            e.printStackTrace();
        }
